 ...
 * {@link WebTTSService}. It simply uses a {@link FileAudioStream} which is
 ...
 */
class WebTTSAudioStream extends FileAudioStream {

	public WebTTSAudioStream(File audioFile) throws AudioException {
		super(audioFile);
	}
